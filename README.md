...
##
We have fit Macquart PDFs for both extragalactic DM (host + cosmic) and cosmic only DM (IGM and intervening halos). These arrays are P(DM | z), not 2D PDFs. These can be found [here](https://github.com/Coherent-All-Sky-Monitor/casm_xengine](https://github.com/liamconnor/frb_baryon_connor2024/blob/main/data/pdm_connor_etal_2025.h5).
